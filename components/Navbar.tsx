...
export default function Navbar() {
  ...
  return (
    <nav className='relative h-full p-4 flex justify-between items-center shadow-md text-green-700 dark:text-green-400 uppercase'>
      {/* Logo / Company Name */}
      ...
      {/* Sidebar */}
      <ul
        className={`absolute flex flex-col items-center justify-center md:justify-start
         top-full right-0 w-full min-h-body bg-gray-200 font-semibold dark:bg-gray-800 md:w-1/3 lg:w-1/4 transform ${
        ...
        <li
          ...
          className={`${
            asPath === '/'
              ...
              : 'hover:text-green-700 dark:hover:text-green-500 hover:bg-gray-100 dark:hover:bg-gray-900'
          } w-full list-none tracking-wide h-full
          px-4 py-6 cursor-pointer uppercase transition-all ease-in-out
